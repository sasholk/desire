...
function watching() {
    watch(['app/scss/**/*.scss'], styles); // автоматическое обновление (если есть измения - запускается gulp styles)
    watch(['app/js/**/*.js', '!app/js/main.min.js'], scripts); // восклицательный знак обозначает исключение (здесь watch не будет следить за min.js)
